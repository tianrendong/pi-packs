...
The dependencies are also listed in `bundledDependencies`, so if this umbrella package is packed/published, the three extension packages are included in the tarball.
